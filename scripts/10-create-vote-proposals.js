...
const vote = sdk.getVote("0x492027cB5f6b45a198b4c80BB94234d4E15A3164");
...
(async () => {
  try {
    const amount = 840_000;
    // Crie uma proposta para cunhar 840.000 novos tokens para o tesouro.
  ...
  try {
    // Crie uma proposta para transferir para nós mesmos 20,700 tokens por sermos irados.
    const amount = 20_700;
