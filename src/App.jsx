...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x0324933DFDF8E73aDA930f6F236E24B0847B1A13");
  const token = useToken("0x9f02755eE15B6153add61f8C35EA89339b03Ad92");
  const vote = useVote("0x492027cB5f6b45a198b4c80BB94234d4E15A3164");
    ...
    const checkBalance = async () => {
      try {
        ...
        if (balance.gt(0)) {
          ...
          console.log("&#x2615; esse usuário de cafeína tem o NFT de membro, CAFÉÉÉ! &#x2615;");
        } else {
          setHasClaimedNFT(false);
          console.log("😭 esse usuário NÃO tem o NFT de membro e vai ficar sem café, alguém ajuda esse ser!.");
        }
      } catch (error) {
        setHasClaimedNFT(false);
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Somos a RoastDAO &#x2615;</h1>
        <button onClick={connectWithMetamask} className="btn-hero">
          Conecte sua carteira
        </button>
        <img src="https://i.imgur.com/mab9kMa.png" />
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>&#x2615; Página dos membros da RoastDAO</h1>
        <p>Parabéns por fazer parte do Bonde do Cafe! &#x2615;</p>
        <div>
          <div>
   ...
   return (
    <div className="mint-nft">
      <h1>Cunhe seu NFT de membro da RoastDAO </h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
